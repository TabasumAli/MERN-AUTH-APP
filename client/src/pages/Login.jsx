        ...
        <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
            ...
            <div className='bg-slate-900 p-4 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form onSubmit={onSubmitHandler} className='flex flex-col items-center'>
                    ...
                    <p onClick={() => navigate('/reset-password')} className='text-center text-xs mt-4'><a href="#" className='text-indigo-400 hover:text-indigo-300'>Forgot Password?</a></p>
                ...
                {state == "Sign up" ? (<p className='text-center mt-4'>Already have an account? {''} <button onClick={() => setState("Login")} className='text-indigo-400 hover:text-indigo-300 cursor-pointer'>Login Here {''}</button></p>) : (<p className='text-center mt-2'>Don't have an account? <button onClick={() => setState("Sign up")} className='text-indigo-400 hover:text-indigo-300 cursor-pointer'>Sign up</button></p>)}
            </div>
